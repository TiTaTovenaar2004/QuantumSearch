...
N = 8 # Number of sites in the graph
marked_vertex = 0
M = 1 # Number of fermions
...
number_of_time_steps = 800 # Number of time steps in the simulation
graph = 'erdos_renyi' # 'complete', 'cycle', 'line', 'erdos_renyi', 'barabasi_albert'
...
init_state_list = [0, 0, 0, 0, 0, 0, 0, 1]
init_state = tensor([basis(2, i) for i in init_state_list])
